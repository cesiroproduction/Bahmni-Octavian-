...
CONTAINER_NAME="bahmni-standard-bahmni-apps-frontend-1"
HOST_DIR="/home/sam/Downloads/bahmni-docker/bahmni-standard/patches/bahmni-apps-frontend"
CONTAINER_DIR="/usr/local/apache2/htdocs/bahmni-new"
