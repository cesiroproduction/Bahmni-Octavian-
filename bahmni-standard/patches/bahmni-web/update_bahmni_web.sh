...
# --- Configuration ---
CONTAINER_NAME="bahmni-standard-bahmni-web-1"
HOST_DIR="/home/sam/Downloads/bahmni-docker/bahmni-standard/patches/bahmni-web/usr-local-apache2-htdocs-bahmni"
CONTAINER_DIR="/usr/local/apache2/htdocs/bahmni"
